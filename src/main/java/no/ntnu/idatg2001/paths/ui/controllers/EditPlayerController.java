...
public class EditPlayerController implements Controller {
  ...
  public void savePlayer() {
    ...
    /**
     * private void updateShowAttributesGridPaneButton() { if (attributesGridPane.isVisible()) {
     * showAttributesGridPaneButton.setText(
     * editPlayerResources.getString("hideAttributesGridPaneButton")); } else {
     * showAttributesGridPaneButton.setText(
     * editPlayerResources.getString("showAttributesGridPaneButton")); } }
     *
     * <p>public void addParametersFromPlayerIntoTextFields() { nameField.setText(player.getName());
     *
     * <p>healthField.setText(String.valueOf(player.getHealth()));
     ...
     *
     * <p>strengthTextField.setText(String.valueOf(player.getAttributes().getStrength()));
     ...
     *
     * <p>public void savePlayer() { Attributes attributes = null; if
     * (defaultAttributesComboBox.isVisible()) { attributes = new
     * Attributes(defaultAttributesComboBox.getValue()); } else if (assertAttributesFieldsValid()) {
     * attributes = new Attributes( Integer.parseInt(strengthTextField.getText()),
     ...
     * Integer.parseInt(agilityTextField.getText()), Integer.parseInt(luckTextField.getText())); }
     * else { WarningAlert warningAlert = new
     * WarningAlert(editPlayerResources.getString("invalidAttributes")); warningAlert.showAndWait();
     * }
     *
     * <p>if (assertAllFieldsValid() && attributes != null) { player.setName(nameField.getText());
     *
     * <p>player.setHealth(Integer.parseInt(healthField.getText()));
     ...
     *
     * <p>player.setAttributes(attributes);
     *
     * <p>PlayerDAO.getInstance().update(player); } }
     */
  }
